...
class DynamicContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final product = {
      ...
      'imageUrl': 'https://i.otto.de/i/otto/780c2bee-3edd-5458-ad7d-68e45a82cd42?h=1040&w=1102&qlt=40&unsharp=0,1,0.6,7&sm=clamp&upscale=true&fmt=auto',
      'description': 'Der vollgefederte E-MTB Klassiker mit kräftigem Mittelmotor bringt Dich mühelos auf den Berg und zeigt abwärts, was es auch in ruppigen Passagen leisten kann. Kraftvoll zupackenden hydraulischen Scheibenbremsen, bieten die notwendige Sicherheit, wenn’s darauf ankommt. Das Pedelec bietet über das Display die Konnektivität via Bluetooth zur FISCHER E-Connect-App.',
      'price': '1.300,00€',
      'delivery': 'GRATIS Lieferung 16-18. Mai',
      'why': 'Erlebe das ultimative Abenteuer mit unseren E-Mountainbikes MONTIS! Der leistungsstarke Motor unterstützt dich auf jedem Trail und die hochwertige Federung sowie robusten Bremsen sorgen für präzise Kontrolle bei jeder Ab- und Auffahrt.'
    };
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: () {},
                        child: const Text('In den Einkaufswagen'),
                      ),
                    ),
                    SizedBox(width: 12),
                    Expanded(
